...
## Overview
This Docker image contains a deployed Shibboleth IdP 3.3.2 running on OpenJDK-based Zulu 8 Update 144 and Jetty 9.3.21 running on the latest CentOS 7 base. This image is a base image and should be used to set the configuration with local changes. 
